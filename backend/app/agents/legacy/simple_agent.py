...
class SimpleScrapingAgent:
    ...
    async def process_message(
        self, message: str, pipeline_id: str, context: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
        ...
        # Handle schema definition
            ...
            response += (
                "'add field <name> <type>' where type is: str, int, float, bool, list\n"
            )
        ...
        # Handle generate code
            ...
            if context["urls"] and context.get("schema"):
                ...
                response = (
                    "✅ Generated Python code for your pipeline. Check the Code tab!"
                )
            else:
    ...
    def _generate_simple_code(self, urls: List[str], schema: Dict[str, Any]) -> str:
